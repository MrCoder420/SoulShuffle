...
export default function Chat() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#fff6f5] dark:bg-[#221517]" style={{ paddingTop: Platform.OS === 'android' ? StatusBar.currentHeight : 0 }}>
      <StatusBar barStyle={isDark ? "light-content" : "dark-content"} backgroundColor={isDark ? "#221517" : "#fff6f5"} />
      
      {/* Header */}
      <View className="flex-row items-center justify-between px-6 py-4 bg-[#fff6f5] dark:bg-[#221517] z-10">
      ...
      >
        ...
        >
          ...
          <View className="flex-row mb-6 items-end relative">
            ...
            />
            <View className="bg-[#e4dad6]/20 dark:bg-[#332225] rounded-2xl rounded-bl-sm p-4 w-[75%] shadow-sm shadow-slate-100 dark:shadow-none border border-white/50 dark:border-rose-950/20 relative">
              ...
              <View className="absolute -bottom-3 -right-2 bg-white dark:bg-[#2A1B1D] px-2 py-0.5 rounded-full flex-row items-center shadow-sm shadow-slate-200 dark:shadow-none border border-slate-50 dark:border-rose-950/20">
          ...
          <View className="w-[90%] self-center bg-white dark:bg-[#332225] rounded-[32px] overflow-hidden shadow-xl shadow-rose-200/40 dark:shadow-none border border-white dark:border-rose-950/20 mb-6">
            <View className="relative h-40 bg-rose-300">
              ...
              />
              <View className="absolute inset-0 bg-[#8a2f3d]/30 dark:bg-[#221517]/50 items-center justify-center">
            ...
            <View className="p-6">
              ...
              <TouchableOpacity
                className="bg-rose-50 dark:bg-[#221517] rounded-full py-4 items-center justify-center border border-rose-100 dark:border-rose-950/40 shadow-sm active:opacity-80"
                onPress={() => {
                  if (!activeChallenge) {
          ...
          <View className="flex-row items-end mb-10 relative">
            ...
            <View className="flex-1">
              ...
              <View className="bg-[#7de5d4] dark:bg-teal-950/20 rounded-full p-2 pl-3 pr-4 shadow-sm w-[75%] flex-row items-center border border-teal-200/50 dark:border-teal-900/40">
                <TouchableOpacity className="bg-white dark:bg-[#332225] w-10 h-10 rounded-full items-center justify-center shadow-sm">
              ...
              <View className="absolute -bottom-8 -left-4 bg-white dark:bg-[#332225] rounded-full px-4 py-2 flex-row items-center gap-2 shadow-xl shadow-slate-300 dark:shadow-none z-20 border border-slate-50 dark:border-rose-950/20">
        ...
        {/* Chat Input Bar */}
        <View className="bg-white dark:bg-[#221517] px-4 py-3 flex-row items-center border-t border-slate-100 dark:border-rose-950/20 shadow-[0_-10px_15px_-3px_rgba(0,0,0,0.05)] dark:shadow-none pb-safe mb-10">
          <TouchableOpacity className="bg-slate-100 dark:bg-[#332225] w-10 h-10 rounded-full items-center justify-center mr-3">
            <Ionicons name="add" size={24} color={isDark ? "#fff" : "#64748b"} />
          </TouchableOpacity>
          
          <View className="flex-1 bg-slate-100 dark:bg-[#332225] rounded-full h-11 flex-row items-center px-4 mr-3">
            <TextInput 
              placeholder="Message..."
